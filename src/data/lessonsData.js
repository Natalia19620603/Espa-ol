...
// ===== ИНТЕГРИРОВАННЫЕ УПРАЖНЕНИЯ В УРОКИ =====
  ...
  'ex-1-1-13-consonants': {
    ...
    words: [
      ...
      { word: 'L', pronunciation: '[l] - как русский Л (не очень твердый) в начале слова и между гласными. [l\'] - перед согласными и в конце слова как ЛЬ.', audioUrl: '/audio/La letra L.mp3' },
      { word: 'limón', pronunciation: '[лимон]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'Lola', pronunciation: '[лола]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'pelo', pronunciation: '[пэло]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'malo', pronunciation: '[мало]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'mal', pronunciation: '[маль]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'pulpo', pronunciation: '[пульпо]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'mil', pronunciation: '[миль]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'tal', pronunciation: '[таль]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'él', pronunciation: '[эль]', audioUrl: '/audio/La letra L.mp3' },
      { word: 'S', pronunciation: '[s] - произносится как приглушенный звук между русскими С и Ш.', audioUrl: '/audio/La letra S.mp3' },
      { word: 'salsa', pronunciation: '[сальса]', audioUrl: '/audio/La letra S.mp3' },
      { word: 'sopa', pronunciation: '[сопа]', audioUrl: '/audio/La letra S.mp3' },
      { word: 'museo', pronunciation: '[мусэо]', audioUrl: '/audio/La letra S.mp3' },
  ...
  'ex-1-1-14-special-consonants': {
    ...
    words: [
      ...
      { word: 'CH', pronunciation: '[ʧ] - произносится как русское Ч.', audioUrl: '/audio/La letra CH.mp3' },
      { word: 'chocolate', pronunciation: '[чоколя́тэ]', audioUrl: '/audio/La letra CH.mp3' },
      { word: 'mucho', pronunciation: '[му́чо]', audioUrl: '/audio/La letra CH.mp3' },
      { word: 'noche', pronunciation: '[но́че]', audioUrl: '/audio/La letra CH.mp3' },
      { word: 'chico', pronunciation: '[чи́ко]', audioUrl: '/audio/La letra CH.mp3' },
      { word: 'ocho', pronunciation: '[о́чо]', audioUrl: '/audio/La letra CH.mp3' },
      { word: 'leche', pronunciation: '[ле́че]', audioUrl: '/audio/La letra CH.mp3' }
    ]
  },
  ...
  'ex-1-1-15-ckq': {
    ...
    words: [
      ...
      { word: 'C перед E, I', pronunciation: '[θ] / [s] - произносится как межзубное С (в Испании) или обычное С (в Латинской Америке).', audioUrl: '/audio/ZA, ZO, ZU, CE, CI.mp3' },
      { word: 'centro', pronunciation: '[θэ́нтро] / [сэ́нтро]', audioUrl: '/audio/ZA, ZO, ZU, CE, CI.mp3' },
      { word: 'cine', pronunciation: '[θи́нэ] / [си́нэ]', audioUrl: '/audio/ZA, ZO, ZU, CE, CI.mp3' },
      { word: 'ciudad', pronunciation: '[θьюда́ð] / [сьюда́ð]', audioUrl: '/audio/ZA, ZO, ZU, CE, CI.mp3' },
      { word: 'precio', pronunciation: '[прэ́θьо] / [прэ́сьо]', audioUrl: '/audio/ZA, ZO, ZU, CE, CI.mp3' },
      { word: 'gracías', pronunciation: '[гра́θьас] / [гра́сьас]', audioUrl: '/audio/ZA, ZO, ZU, CE, CI.mp3' },
      { word: 'K', pronunciation: '[k] - всегда произносится как русское К (встречается редко, в основном в иностранных словах).', audioUrl: '/audio/La K.mp3' },
      { word: 'kilo', pronunciation: '[ки́ло]', audioUrl: '/audio/La K.mp3' },
      { word: 'kilómetro', pronunciation: '[кило́мэтро]', audioUrl: '/audio/La K.mp3' },
      { word: 'karate', pronunciation: '[кара́тэ]', audioUrl: '/audio/La K.mp3' },
      { word: 'kiosco', pronunciation: '[кьо́ско]', audioUrl: '/audio/La K.mp3' },
