...
// Total integrated exercises created: 10
  ...
  'ex-3-3-5': {
    ...
    questions: [
      { sentence: 'Veo a mi amiga en la calle.', correct: 'La veo en la calle.' },
      { sentence: 'Compro el periódico cada día.', correct: 'Lo compro cada día.' },
      { sentence: 'Llamo a mis padres por teléfono.', correct: 'Los llamo por teléfono.' },
      { sentence: 'Estudiamos las lecciones por la tarde.', correct: 'Las estudiamos por la tarde.' },
      { sentence: 'Ellos conocen a Juan.', correct: 'Ellos lo conocen.' },
      { sentence: 'Mi hermana lee el libro.', correct: 'Mi hermana lo lee.' },
      { sentence: '¿Tienes las entradas?', correct: '¿Las tienes?' },
      { sentence: 'No entiendo la pregunta.', correct: 'No la entiendo.' },
      { sentence: 'Invitamos a María a la fiesta.', correct: 'La invitamos a la fiesta.' },
      { sentence: 'El profesor explica la gramática.', correct: 'El profesor la explica.' },
      { sentence: 'Busco mis gafas por toda la casa.', correct: 'Las busco por toda la casa.' },
      { sentence: 'Mis amigos visitan el museo del Prado.', correct: 'Mis amigos lo visitan.' },
      { sentence: 'Escribo un correo a mi jefa.', correct: 'Lo escribo a mi jefa.' },
      { sentence: '¿Ves a estos estudiantes en la universidad?', correct: '¿Los ves en la universidad?' },
      { sentence: 'Necesitamos las llaves del coche.', correct: 'Las necesitamos.' }
    ]
  },
  ...
  'ex-3-3-10': {
    ...
    questions: [
      { sentence: 'Me gusta el invierno.', correct: 'No me gusta el invierno.' },
      { sentence: 'Lo veo todos los días.', correct: 'No lo veo todos los días.' },
      { sentence: 'Te escribo cartas.', correct: 'No te escribo cartas.' },
      { sentence: 'Nos explica la lección.', correct: 'No nos explica la lección.' },
      { sentence: 'La conozco bien.', correct: 'No la conozco bien.' },
      { sentence: 'Les gusta bailar.', correct: 'No les gusta bailar.' },
      { sentence: 'Os doy el dinero.', correct: 'No os doy el dinero.' },
      { sentence: 'Los invitamos a la fiesta.', correct: 'No los invitamos a la fiesta.' },
      { sentence: 'Me lo das.', correct: 'No me lo das.' },
      { sentence: 'Se la explicamos.', correct: 'No se la explicamos.' },
      { sentence: 'Te gusta estudiar.', correct: 'No te gusta estudiar.' },
      { sentence: 'Las compro en el mercado.', correct: 'No las compro en el mercado.' },
      { sentence: 'Nos llaman por teléfono.', correct: 'No nos llaman por teléfono.' },
      { sentence: 'Se los mando mañana.', correct: 'No se los mando mañana.' },
      { sentence: 'Me encanta este restaurante.', correct: 'No me encanta este restaurante.' }
    ]
  },
