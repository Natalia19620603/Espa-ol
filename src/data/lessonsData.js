...
Carlos tiene un coche. El coche es verde y pequeño. También tiene una flor azul en la casa.
  ...
  'ex-2-1-3': {
    ...
    description: 'Прочитайте текст и ответьте на вопросы',
    text: 'Ana, Pedro y Pablo se encuentran. Ana: ¡Hola! Buenos días. Pablo: Buenos días, Ana. ¿Qué tal estás? Ana: Bien, gracias. ¿Y tú? Pablo: Todo va bien. Soy de España. ¿De dónde eres tú? Ana: Yo soy de Rusia. Pablo: ¿Dónde está tu casa? Ana: Mi casa está en la ciudad de Madrid. Es una casa grande y bonita. Pablo: ¡Qué bien! Yo soy de Moscú. ¿Eres estudiante? Ana: No, soy pintora. Él es mi amigo, Pedro. Él es abogado. Pablo: Mucho gusto. Pedro: Encantado. Pablo: Vamos a tomar un café. Ana: No, gracias. Vamos a salir. Yo voy a ver a mi hermana. Pedro: ¿Vais en coche? Ana: Sí, vamos en coche. Mi amigo es mi profesor. Él va a dar un libro a mi hermana. Pablo: ¡Qué bueno! Yo voy a escribir un mensaje para mi amiga. Pedro: ¿Tu amiga vive en Moscú? Pablo: No, ella vive en una ciudad de España. ¡Adiós! Muchas gracias. Ana y Pedro: Adiós.',
    questions: [
      { question: '¿De dónde es Pablo?', options: ['De Rusia', 'De España', 'De China', 'De Francia'], correct: 1 },
      { question: '¿De dónde es Ana?', options: ['De España', 'De Moscú', 'De Rusia', 'De Madrid'], correct: 2 },
      { question: '¿Dónde está la casa de Ana?', options: ['En Moscú', 'En Barcelona', 'En Madrid', 'En Valencia'], correct: 2 },
      { question: '¿Cómo es la casa de Ana?', options: ['Pequeña y vieja', 'Grande y bonita', 'Pequeña y bonita', 'Grande y vieja'], correct: 1 },
      { question: '¿De qué ciudad es Pablo?', options: ['De Barcelona', 'De Moscú', 'De Madrid', 'De Valencia'], correct: 1 },
      { question: '¿Es Ana estudiante?', options: ['Sí, es estudiante', 'No, es pintora', 'No, es profesora', 'Sí, es abogada'], correct: 1 },
      { question: '¿Qué es Pedro?', options: ['Estudiante', 'Profesor', 'Abogado', 'Pintor'], correct: 2 },
      { question: '¿Qué va a tomar Pablo?', options: ['Té', 'Agua', 'Un café', 'Zumo'], correct: 2 },
      ...
      { question: '¿Quién es el amigo de Ana?', options: ['Su abogado', 'Su profesor', 'Su médico', 'Su hermano'], correct: 1 },
      { question: '¿Qué va a dar el profesor a la hermana de Ana?', options: ['Un mensaje', 'Un café', 'Un libro', 'Una carta'], correct: 2 },
      { question: '¿Qué va a escribir Pablo?', options: ['Un libro', 'Una carta', 'Un mensaje', 'Un texto'], correct: 2 },
      { question: '¿Para quién va a escribir Pablo?', options: ['Para su hermana', 'Para su madre', 'Para su profesora', 'Para su amiga'], correct: 3 },
      { question: '¿Dónde vive la amiga de Pablo?', options: ['En Moscú', 'En una ciudad de España', 'En Madrid', 'En Rusia'], correct: 1 }
    ]
  },
  'ex-2-1-4': {
    id: 'ex-2-1-4',
