...
// ===== ИНТЕГРИРОВАННЫЕ УПРАЖНЕНИЯ В УРОКИ =====
  ...
  'ex-1-1-15-ckq': {
    ...
    words: [
      { word: 'C перед A, O, U', pronunciation: '[k] - произносится как русское К.' },
      ...
      { word: 'C перед E, I', pronunciation: '[θ] / [s] - произносится как межзубное С (в Испании) или обычное С (в Латинской Америке).' },
