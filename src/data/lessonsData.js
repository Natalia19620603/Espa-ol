...
// ===== ИНТЕГРИРОВАННЫЕ УПРАЖНЕНИЯ В УРОКИ =====
  ...
  'ex-1-1-7-pron-a': {
    ...
    introAudio: '/audio/consonantes%20(A1U0C11).mp3',
    words: [
  ...
  'ex-1-1-13-consonants': {
    ...
    introAudio: '/audio/consonantes%20(A1U0C11).mp3',
    words: [
      { word: 'P, F, T, N, M', pronunciation: 'Произносятся как твердые русские звуки. Никогда не смягчаются.', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'mapa', pronunciation: '[мапа]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'papá', pronunciation: '[папа́]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'fama', pronunciation: '[фама]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'tema', pronunciation: '[тэма]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'patata', pronunciation: '[патата]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'moto', pronunciation: '[мото]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'mamá', pronunciation: '[мама́]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'Ana', pronunciation: '[ана]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'L', pronunciation: '[l] - как русский Л (не очень твердый) в начале слова и между гласными. [l\'] - перед согласными и в конце слова как ЛЬ.', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'limón', pronunciation: '[лимон]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'Lola', pronunciation: '[лола]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'pelo', pronunciation: '[пэло]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'malo', pronunciation: '[мало]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'mal', pronunciation: '[маль]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'pulpo', pronunciation: '[пульпо]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'mil', pronunciation: '[миль]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'tal', pronunciation: '[таль]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'él', pronunciation: '[эль]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'S', pronunciation: '[s] - произносится как приглушенный звук между русскими С и Ш.', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'salsa', pronunciation: '[сальса]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'sopa', pronunciation: '[сопа]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'museo', pronunciation: '[мусэо]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'mes', pronunciation: '[мэс]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'R', pronunciation: '[r] - в середине и конце слова как русский Р. [ř] - раскатистое Р в начале слова и после L, N, S.', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'toro', pronunciation: '[торо]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'primo', pronunciation: '[примо]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'enero', pronunciation: '[энэро]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'fruta', pronunciation: '[фрута]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'mar', pronunciation: '[мар]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'flor', pronunciation: '[флор]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'Roma', pronunciation: '[ррома]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'ruso', pronunciation: '[ррусо]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'Enrique', pronunciation: '[энррикэ]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'el rumbo', pronunciation: '[эль ррумбо]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'las rosas', pronunciation: '[лас ррросас]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'RR', pronunciation: '[ř] - встречается только в середине слова и всегда произносится как раскатистое Р.', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'perro', pronunciation: '[пэрро]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'error', pronunciation: '[эррор]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'torre', pronunciation: '[торрэ]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'carretera', pronunciation: '[каррэтэра]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' },
      { word: 'carroza', pronunciation: '[карроса]', audioUrl: '/audio/consonantes%20(A1U0C11).mp3' }
    ]
  },
