...
// ===== ИНТЕГРИРОВАННЫЕ УПРАЖНЕНИЯ В УРОКИ =====
  ...
  'ex-1-1-14-special-consonants': {
    ...
    words: [
      { word: 'H', pronunciation: 'Буква H в испанском языке НЕ ПРОИЗНОСИТСЯ (немая).', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'hola', pronunciation: '[о́ла]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'hora', pronunciation: '[о́ра]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'hotel', pronunciation: '[отэ́ль]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'hombre', pronunciation: '[о́мбрэ]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'hasta', pronunciation: '[а́ста]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'ahora', pronunciation: '[ао́ра]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'Ñ', pronunciation: '[ɲ] - произносится как мягкое НЬ (похоже на русское "нь" в слове "конь").', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'niño', pronunciation: '[ни́ньо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'año', pronunciation: '[а́ньо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'español', pronunciation: '[эспаньо́ль]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'señor', pronunciation: '[сэньо́р]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'mañana', pronunciation: '[манья́на]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'pequeño', pronunciation: '[пэкэ́ньо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'LL', pronunciation: '[ʎ] / [j] - произносится как мягкое ЛЬ или Й (в зависимости от региона).', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'llamo', pronunciation: '[льа́мо] / [йа́мо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'calle', pronunciation: '[ка́лье] / [ка́йе]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'llamar', pronunciation: '[льама́р] / [йама́р]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'llorar', pronunciation: '[льора́р] / [йора́р]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'pollo', pronunciation: '[по́льо] / [по́йо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'amarillo', pronunciation: '[амари́льо] / [амари́йо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'CH', pronunciation: '[ʧ] - произносится как русское Ч.', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'chocolate', pronunciation: '[чоколя́тэ]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'mucho', pronunciation: '[му́чо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'noche', pronunciation: '[но́че]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'chico', pronunciation: '[чи́ко]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'ocho', pronunciation: '[о́чо]', audioUrl: '/audio/h, ñ, ll, ch.mp3' },
      { word: 'leche', pronunciation: '[ле́че]', audioUrl: '/audio/h, ñ, ll, ch.mp3' }
    ]
  },
  ...
  'ex-1-1-15-ckq': {
    ...
    words: [
      { word: 'C перед A, O, U', pronunciation: '[k] - произносится как русское К.', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'casa', pronunciation: '[ка́са]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'como', pronunciation: '[ко́мо]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'Cuba', pronunciation: '[ку́ба]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'café', pronunciation: '[кафэ́]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'cosa', pronunciation: '[ко́са]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'C перед E, I', pronunciation: '[θ] / [s] - произносится как межзубное С (в Испании) или обычное С (в Латинской Америке).', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'centro', pronunciation: '[θэ́нтро] / [сэ́нтро]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'cine', pronunciation: '[θи́нэ] / [си́нэ]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'ciudad', pronunciation: '[θьюда́ð] / [сьюда́ð]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'precio', pronunciation: '[прэ́θьо] / [прэ́сьо]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'gracías', pronunciation: '[гра́θьас] / [гра́сьас]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'K', pronunciation: '[k] - всегда произносится как русское К (встречается редко, в основном в иностранных словах).', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'kilo', pronunciation: '[ки́ло]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'kilómetro', pronunciation: '[кило́мэтро]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'karate', pronunciation: '[кара́тэ]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'kiosco', pronunciation: '[кьо́ско]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'Q (+ ue, ui)', pronunciation: '[k] - всегда идет с буквой U (que, qui), буква U не читается, произносится как К.', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'que', pronunciation: '[кэ]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'quiero', pronunciation: '[кьэ́ро]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'quince', pronunciation: '[ки́нθэ] / [ки́нсэ]', audioUrl: '/audio/c, q, k.mp3' },
      { word: 'pequeño', pronunciation: '[пэкэ́ньо]', audioUrl: '/audio/c, q, k.mp3' },
