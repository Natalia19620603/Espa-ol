...
Carlos tiene un coche. El coche es verde y pequeño. También tiene una flor azul en la casa.
  ...
  'ex-4-3-2': {
    ...
    description: 'Используйте степени сравнения прилагательных',
    questions: [
      { russian: 'Метро быстрее автобуса', correct: 'el metro es más rápido que el autobús' },
      { russian: 'Такси удобнее общественного транспорта', correct: 'el taxi es más cómodo que el transporte público' },
      { russian: 'Эта поездка дороже той', correct: 'este viaje es más caro que aquel' },
      { russian: 'Автобус дешевле такси', correct: 'el autobús es más barato que el taxi' },
      { russian: 'Этот поезд самый быстрый', correct: 'este tren es el más rápido' },
      { russian: 'Эта станция самая большая в городе', correct: 'esta estación es la más grande de la ciudad' },
      { russian: 'Такси такое же удобное, как автомобиль', correct: 'el taxi es tan cómodo como el coche' },
      { russian: 'Эта линия метро менее популярна', correct: 'esta línea de metro es menos popular' },
      { russian: 'Городской транспорт самый экологичный', correct: 'el transporte urbano es el más ecológico' },
      { russian: 'Этот маршрут короче', correct: 'esta ruta es más corta' }
    ]
  },
  'ex-4-3-3': {
    id: 'ex-4-3-3',
  ...
  'ex-4-3-4': {
    id: 'ex-4-3-4',
    type: 'fillblank',
    title: 'Заполните правильной формой сравнения',
    description: 'Вставьте прилагательное в нужной степени',
    questions: [
      { sentence: 'El metro es _____ rápido que el autobús', verb: 'más/menos/tan', correct: 'más' },
      { sentence: 'Esta estación es _____ grande de la ciudad', verb: 'превосходная степень', correct: 'la más' },
      { sentence: 'El taxi es _____ cómodo como el coche', verb: 'tan/más/menos', correct: 'tan' },
      { sentence: 'El tren es _____ lento que el avión', verb: 'más/menos', correct: 'más' },
      { sentence: 'Esta ruta es _____ larga de todas', verb: 'превосходная степень', correct: 'la más' },
      { sentence: 'Viajar en autobús es _____ barato que en taxi', verb: 'más/menos', correct: 'más' },
      { sentence: 'Este viaje es _____ interesante que aquel', verb: 'más/menos/tan', correct: 'más' },
      { sentence: 'La tarjeta de transporte es _____ práctica', verb: 'muy/más/la más', correct: 'muy' },
      { sentence: 'El metro es _____ rápido de todos los transportes urbanos', verb: 'превосходная степень', correct: 'el más' },
      { sentence: 'Caminar es _____ lento como ir en bicicleta', verb: 'tan/más/menos', correct: 'tan' }
    ]
  },
  'ex-4-3-5': {
    id: 'ex-4-3-5',
    type: 'grammar',
    title: 'Транспорт и степени сравнения',
...
// Total integrated exercises created: 10
  ...
  'ex-3-3-5': {
    id: 'ex-3-3-5',
    type: 'fillblank',
    title: 'Упражнение 5: Местоимения винительного падежа в контексте',
    description: 'Вставьте правильное местоимение: lo, la, los, las',
    questions: [
      { sentence: '¿Ves a mi amiga? — Sí, ___ veo en la calle.', correct: 'la', blanks: 1 },
      { sentence: '¿Compras el periódico? — Sí, ___ compro cada día.', correct: 'lo', blanks: 1 },
      { sentence: '¿Llamas a tus padres? — Sí, ___ llamo por teléfono.', correct: 'los', blanks: 1 },
      { sentence: '¿Estudias las lecciones? — Sí, ___ estudiamos por la tarde.', correct: 'las', blanks: 1 },
      { sentence: '¿Conocen a Juan? — Sí, ellos ___ conocen.', correct: 'lo', blanks: 1 },
      { sentence: '¿Lee tu hermana el libro? — Sí, mi hermana ___ lee.', correct: 'lo', blanks: 1 },
      { sentence: '¿Tienes las entradas? — Sí, ___ tengo.', correct: 'las', blanks: 1 },
      { sentence: '¿Entiendes la pregunta? — No, no ___ entiendo.', correct: 'la', blanks: 1 },
      { sentence: '¿Invitáis a María? — Sí, ___ invitamos a la fiesta.', correct: 'la', blanks: 1 },
      { sentence: '¿El profesor explica la gramática? — Sí, ___ explica.', correct: 'la', blanks: 1 },
      { sentence: '¿Buscas tus gafas? — Sí, ___ busco por toda la casa.', correct: 'las', blanks: 1 },
      { sentence: '¿Visitan el museo? — Sí, mis amigos ___ visitan.', correct: 'lo', blanks: 1 },
      { sentence: '¿Escribes un correo? — Sí, ___ escribo a mi jefa.', correct: 'lo', blanks: 1 },
      { sentence: '¿Ves a estos estudiantes? — Sí, ___ veo en la universidad.', correct: 'los', blanks: 1 },
      { sentence: '¿Necesitáis las llaves? — Sí, ___ necesitamos.', correct: 'las', blanks: 1 }
    ]
  },
  ...
  'ex-3-3-10': {
    id: 'ex-3-3-10',
    type: 'fillblank',
    title: 'Упражнение 10: Отрицательные предложения с местоимениями',
    description: 'Вставьте правильное местоимение в отрицательное предложение',
    questions: [
      { sentence: 'No ___ gusta el invierno. (a mí)', correct: 'me', blanks: 1 },
      { sentence: 'No ___ veo todos los días. (él)', correct: 'lo', blanks: 1 },
      { sentence: 'No ___ escribo cartas. (a ti)', correct: 'te', blanks: 1 },
      { sentence: 'No ___ explica la lección. (a nosotros)', correct: 'nos', blanks: 1 },
      { sentence: 'No ___ conozco bien. (ella)', correct: 'la', blanks: 1 },
      { sentence: 'No ___ gusta bailar. (a ellos)', correct: 'les', blanks: 1 },
      { sentence: 'No ___ doy el dinero. (a vosotros)', correct: 'os', blanks: 1 },
      { sentence: 'No ___ invitamos a la fiesta. (ellos)', correct: 'los', blanks: 1 },
      { sentence: 'No ___ ___ das. (a mí / eso)', correct: 'me lo', blanks: 1 },
      { sentence: 'No ___ ___ explicamos. (a él/ella / eso)', correct: 'se la', blanks: 1 },
      { sentence: 'No ___ gusta estudiar. (a ti)', correct: 'te', blanks: 1 },
      { sentence: 'No ___ compro en el mercado. (ellas)', correct: 'las', blanks: 1 },
      { sentence: 'No ___ llaman por teléfono. (a nosotros)', correct: 'nos', blanks: 1 },
      { sentence: 'No ___ ___ mando mañana. (a él/ella / ellos)', correct: 'se los', blanks: 1 },
      { sentence: 'No ___ encanta este restaurante. (a mí)', correct: 'me', blanks: 1 }
    ]
  },
